...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
                <?= Html::a(
                'Выход (' . (Identity::findIdentity(Yii::$app->user->id))->getUsername() . ')',
                ['auth/auth/logout'],
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="<?= Url::to(['site/index']); ?>" class="brand-link">
            <?= Html::img(['img/icon_for_mail.png'], ['alt' => Yii::$app->name, 'class' => 'brand-image img-circle elevation-3', 'style' => 'opacity: .8']); ?>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; <?= date('Y'); ?> <?= Html::a(Yii::$app->name, Url::to(['site/index'], true)); ?>.</strong> All rights
        reserved.
    </footer>
